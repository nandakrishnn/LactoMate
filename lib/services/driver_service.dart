...
class DriverService {
  Future<bool> saveDriverDetils(
      String id, Map<String, dynamic> driverDetails) async {
    try {
  ...
  Future<bool> updateDriverDetails(
    ...
    try {
      DocumentReference driverCategory =
          FirebaseFirestore.instance.collection("DriverDetails").doc(id);
  ...
  Future<Map<String, dynamic>> getDriverDetail(
    String id,
  ) async {
