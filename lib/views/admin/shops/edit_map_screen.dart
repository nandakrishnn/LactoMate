...
class EditScreenMap extends StatefulWidget {
  final String location;
  final Function(Map<String, dynamic>?) onLocationSelected;

  EditScreenMap({required this.onLocationSelected, required this.location});
  @override
  _EditSearchMapScreenState createState() => _EditSearchMapScreenState();
}

class _EditSearchMapScreenState extends State<EditScreenMap> {
